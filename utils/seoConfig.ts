...
export const seoConfig = {
	baseURL: "https://glasses.widyamatador.com", // Change this to your production URL.
	description:
	...
	siteName: "bAMBU kUNING", // Change this to your website's name,
	twitter: {
...
export const manifest: Partial<ManifestOptions> = {
	name: "Bambu Kuning", // Change this to your website's name.
	short_name: "Bambu Kuning", // Change this to your website's short name.
	description:
